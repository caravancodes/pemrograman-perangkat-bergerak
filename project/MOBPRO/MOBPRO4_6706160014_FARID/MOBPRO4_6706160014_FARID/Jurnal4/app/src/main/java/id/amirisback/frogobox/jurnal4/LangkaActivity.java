...
public class LangkaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] daftar = {"Anoa", "Bekantan", "Burung Jalak Bali", "Burung Enggang Gading", "Burung Maleo Senkawor", "Burung Mandar Dengkur", "Mentilin", "Ikan Pesut Mahakam", "Rusa Timor", "Tangkasi"};
