...
public class HutanLoader extends AsyncTaskLoader<List<NewWord>> {
    private static final String LOG_TAG = HutanLoader.class.getName();
    private String mUrl;

    public HutanLoader(Context context, String url) {
        super(context);
    ...
    public List<NewWord> loadInBackground() {
        ...
        List<NewWord> earthquakes = QueryUtils.fetchHutanData(mUrl);
        return earthquakes;
