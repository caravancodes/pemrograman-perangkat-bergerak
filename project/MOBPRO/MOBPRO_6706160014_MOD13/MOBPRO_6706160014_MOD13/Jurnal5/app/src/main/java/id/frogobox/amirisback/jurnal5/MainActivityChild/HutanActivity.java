...
public class HutanActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewWord>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new WordAdapter(this, new ArrayList<NewWord>(), R.color.category_hutan);
        ...
        listViews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View parent, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(HutanActivity.this, new ArrayList<NewWord>().get(position).getSuara());
                    mMediaPlayer.start();
    ...
    public Loader<List<NewWord>> onCreateLoader(int i, Bundle bundle) {
        return new HutanLoader(this, USGS_REQUEST_URL);
    }
